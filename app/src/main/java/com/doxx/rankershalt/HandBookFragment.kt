...
class HandBookFragment: Fragment(R.layout.fragment_jee_books_list),ItemClicked {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bookName= arrayOf(
            "Arihant Physics Handbook",
            "Arihant Chemistry Handbook",
            "Arihant Biology Handbook",
            "Arihant Mathematics Handbook"
        )
        links= arrayOf(
            "https://drive.google.com/uc?export=download&id=1tJON5j04pE-kS__aY-K1CwtLkaV8IOrt",
            "https://drive.google.com/uc?export=download&id=1biB6gxiAYBkR8w1S1gDbKY8Ux9HtkMuf",
            "https://drive.google.com/uc?export=download&id=1EG3Lf-kOKm3J8Zcz9HfbliqbWdrCdGM5",
            "https://drive.google.com/uc?export=download&id=1nUgHiJl-BXg7LK54XeIibbswItcGjBjp"
        )
