...
class ComedkTestPaperFragment: Fragment(R.layout.fragment_jee_books_list),ItemClicked {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        links= arrayOf(
            "https://drive.google.com/uc?export=download&id=1AKTDcAvJIGpvPaR0LKINtSt7qVz-N_M",
